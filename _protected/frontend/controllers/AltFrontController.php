...
class AltFrontController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($_GET['alt_frontTitle']!==""&&$_GET['alt_fronmtBody']!==""&&$_GET['alt_frontimg']!=="") {

            $model->alt_frontTitle = $_GET['alt_frontTitle'];
            $model->alt_fronmtBody = $_GET['alt_fronmtBody'];
            $model->alt_frontimg = $_GET['alt_frontimg'];
            $model->save();

            return $model->alt_frontID;
        } else {
            echo 'oops';
